...
public class JavaLevel2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        previewimg.setImageResource(R.drawable.previeimgjavatwo);
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(JavaLevel2.this,JavaGameLevels.class);
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    Intent intent = new Intent(JavaLevel2.this, JavaLevel3.class);
                    startActivity(intent);
                    finish();
                }catch (Exception e){
                    //
        ...
        final Animation a = AnimationUtils.loadAnimation(JavaLevel2.this,R.anim.alpha);// Підключення анімації


        numLeft = random.nextInt(19);// Генеруємо випадкове число від 0 до 9
        img_left.setImageResource(array.images2[numLeft]); // Дістаємо з масиву відповідну картинку
        text_left.setText(array.text2[numLeft]);

        numRight = random.nextInt(19);// Генеруємо випадкове число від 0 до 9

        while (numLeft == numRight ){
            numRight = random.nextInt(19);
        }

        img_right.setImageResource(array.images2[numRight]); // Дістаємо з масиву відповідну картинку
