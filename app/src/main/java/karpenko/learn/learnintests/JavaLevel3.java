...
public class JavaLevel3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(JavaLevel3.this,JavaGameLevels.class);
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    Intent intent = new Intent(JavaLevel3.this, JavaLevel4.class);
                    startActivity(intent);
                    finish();
                }catch (Exception e){
                    //
        ...
        final Animation a = AnimationUtils.loadAnimation(JavaLevel3.this,R.anim.alpha);// Підключення анімації


        numLeft = random.nextInt(10);// Генеруємо випадкове число від 0 до 9
        img_left.setImageResource(array.images3[numLeft]); // Дістаємо з масиву відповідну картинку
        ...
        img_right.setImageResource(array.images3[numRight]); // Дістаємо з масиву відповідну картинку
