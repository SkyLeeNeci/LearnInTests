...
public class JavaLevel4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(JavaLevel4.this,JavaGameLevels.class);
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    Intent intent = new Intent(JavaLevel4.this, JavaLevel4.class);
                    startActivity(intent);
                    finish();
                }catch (Exception e){
                    //
        ...
        final Animation a = AnimationUtils.loadAnimation(JavaLevel4.this,R.anim.alpha);// Підключення анімації
