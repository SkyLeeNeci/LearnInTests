...
public class JavaLevel1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnclose.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                try {
                    Intent intent = new Intent(JavaLevel1.this,JavaGameLevels.class);
        ...
        btncontinue2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    Intent intent = new Intent(JavaLevel1.this, JavaLevel2.class);
                    startActivity(intent);
                    finish();
                }catch (Exception e){
                    //
        ...
        final Animation a = AnimationUtils.loadAnimation(JavaLevel1.this,R.anim.alpha);// Підключення анімації


        numLeft = random.nextInt(10);// Генеруємо випадкове число від 0 до 9
        img_left.setImageResource(array.images1[numLeft]); // Дістаємо з масиву відповідну картинку
        text_left.setText(array.text1[numLeft]);

        numRight = random.nextInt(10);// Генеруємо випадкове число від 0 до 9

        while (numLeft == numRight ){
            numRight = random.nextInt(10);
        }

        img_right.setImageResource(array.images1[numRight]); // Дістаємо з масиву відповідну картинку
